...
import ProviderMobilityGuidesPanel from "@/components/mobility-guides/ProviderMobilityGuidesPanel";
...
export default function MobilityGuidesPage() {
  ...
  const [selectedAsset, setSelectedAsset] = useState<MobilityAsset | null>(
    null,
  );
    ...
    <Container size="xl" py="xl">
      <Stack gap="lg">
        <Group justify="space-between" align="flex-start">
          <div>
            <Text component="h1" fw={800} fz={{ base: 26, sm: 32 }}>
              Guias de movilidad
            </Text>
            <Text c="dimmed">
              Consulta, publica y controla la vigencia de las guias por activo.
            </Text>
          </div>
        </Group>
        ...
        <Tabs defaultValue="own" keepMounted={false}>
          <Tabs.List>
            <Tabs.Tab value="own">Bodega propia</Tabs.Tab>
            <Tabs.Tab value="providers">Proveedores</Tabs.Tab>
          </Tabs.List>
              ...
              >
                {assets.map((asset) => (
                  <SerialAssetCard
                    ...
                    statusBadge={getMobilityGuideStatus(
                      asset.latestGuide?.expiresAt,
                    )}
                    additionalDetails={[
          ...
          <Tabs.Panel value="providers">
            <ProviderMobilityGuidesPanel canManage={canManage} />
          </Tabs.Panel>
        </Tabs>
      </Stack>
