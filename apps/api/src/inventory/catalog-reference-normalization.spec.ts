...
describe('catalog reference normalization', () => {
  it.each([
    ...
    ['60 CM', '0.60 M'],
    ['3 M', '3.00 M'],
    ['2.30M - 3.60M', '2.30 M - 3.60 M'],
    ['0,10 M x 0,60 M', '0.10 M X 0.60 M'],
  ])('normalizes %s as %s', (source, expected) => {
    expect(normalizeMeasurementLabel(source)).toBe(expected);
  });

  it.each([
    ['ANGULO DE 0.60 CM', '0.60M', 'ÁNGULO (0.60 M)'],
    ['ANGULO DE 0.30 MT', '0.30M', 'ÁNGULO (0.30 M)'],
    ['TENSOR DE 0.60 CM', '0.60M', 'TENSOR (0.60 M)'],
    [
    ...
    ['DIAGONALES (3.00M)', '3.00M', 'DIAGONALES (3.00 M)'],
    ...
    ['CABLE PARA ANDAMIO 50,00M', null, 'CABLE PARA ANDAMIO 50.00 M'],
